...
public class PostServiceTest {
    ...
    public void should_CreatePostAndReturnPostDTO_When_PostExists() {
        ...
        //TODO: look over the "devCat"
        PostDTO postDTO = new PostDTO(post.getPostId(), post.getContent(), post.getTitle(), post.getDeveloper(), post.getComments(), "devCat", "datetime");
    ...
    public void should_FindPostById_When_PostExists() {
        ...
        Post post = new Post(postId,
                ...
                "This application is a social media platform for dogs. Dogs should be able to follow eachother" +
                        "and like each other photos and so on and so forth...");
        PostDTO postDTO = new PostDTO(post.getPostId(), post.getContent(), post.getTitle(), post.getDeveloper(), post.getComments(),"devCat", "dateTime"); // TODO: fixa datetime på riktigt här
