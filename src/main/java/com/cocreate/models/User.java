...
@Entity
@Table(name="users") // if the names of the entity class and the db table does not match, use this to clarify it.
public class User {
    ...
    private int userId;
    @NotEmpty(message = "Useeer name cannot be empty!")                   // part of the jakarta validation dependency
    @Column(unique = true)      // user name needs to be unique
    private String userName;
    @NotEmpty(message = "Emaaail cannot be empty!")
